  ...
  const loadPage = async (page: number, itemsPerPage: number = perPage) => {
    ...
    try {
      const response = await fetch(
        `/api/products?page=${page}&perPage=${itemsPerPage}`
      );
      ...
      if (data.success && data.data) {
        ...
        const errorMessage = data.error || "Failed to fetch page";
      ...
      >
        ...
        <div className="flex-1 min-h-0 px-4 md:px-6 lg:px-8 pb-2 overflow-hidden flex flex-col">
          {filteredData && filteredData.length > 0 && (
            <div
              className="relative flex flex-col w-full h-full rounded-lg bg-clip-border"
              style={{
                backgroundColor: "#FFFFFF",
                boxShadow: "0 1px 2px rgba(0,0,0,0.05)",
                borderRadius: "8px",
                  ...
                  <thead className="sticky top-0 z-10">
                    <tr>
                      {tableHeaders.map((header) => (
                        ...
                        >
                          <p
                            className="text-s leading-none whitespace-nowrap"
              ...
              >
                <div className="text-sm" style={{ color: "#4B5563" }}>
                  ...
                  {totalPages > 0 && (
                    <span>
                      {" "}
                      (Page <b style={{ color: "#000000" }}>
                        {currentPage}
                      </b> of <b style={{ color: "#000000" }}>{totalPages}</b>)
                    </span>
                  )}
                </div>
                  ...
                  <div className="flex space-x-1">
                    <button
                      ...
                      style={{
                        ...
                        borderWidth: "1px",
                        color:
                          currentPage <= 1 || loading ? "#9CA3AF" : "#000000",
                        cursor:
